...
//       .then((profile, err)=> {
//         "use strict";
//         console.log(`creating profile relationship between ${user.id} --> ${profile.id}`);
...
//   var createNamedClient = (name, trusted, redirectURI)=> {
//     "use strict";
...
//       // Create a trusted application
//       createNamedClient('trustedTestClient', 'http://localhost:1338', true),

//       // Create an untrusted application
//       createNamedClient('untrustedTestClient', 'http://localhost:1339', false)
//     ]);
